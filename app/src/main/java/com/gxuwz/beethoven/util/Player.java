...
public class Player implements OnBufferingUpdateListener, OnCompletionListener, OnPreparedListener {
    ...
    Handler handler = new Handler() {
        public void handleMessage(android.os.Message msg) {
            ...
            if (duration > 0) {
                ...
                currentAndMaxTime.setText(DateUtil.sToDate(currentTime)+"/"+DateUtil.sToDate(totalTime));
                }
            }
        };
    };
    ...
    public void onBufferingUpdate(MediaPlayer mp, int percent) {
        ...
        // currentProgress = seekBar.getMax() * mediaPlayer.getCurrentPosition() / mediaPlayer.getDuration();
