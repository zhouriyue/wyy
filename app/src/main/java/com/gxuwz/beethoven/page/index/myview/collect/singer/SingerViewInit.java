package com.gxuwz.beethoven.page.index.myview.collect.singer;
...
import com.gxuwz.beethoven.adapter.my.collect.SingerItemAdapter;
...
public class SingerViewInit {
    ...
    public void setData(){
        ...
        singerItem.setAlbumCount(81);
        singerItem.setMvCount(60);
